...
<body class="{{Route::is('contenidos','dashboard','banners') ? 'alt-menu layout-boxed':'layout-boxed'}}">
    <!-- BEGIN LOADER -->
    <div id="load_screen"> 
        <div class="loader"> 
    ...
    {{-- <script src="{{ asset('/assets-cork/layouts/modern-dark-menu/app.js')}}"></script> --}}
